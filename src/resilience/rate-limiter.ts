import { RateLimitStatus, RateLimitConfig, EventHandler, EventData } from '../types.js';
...
export class RateLimiter {
   ...
   */
  on(event: 'throttled', handler: EventHandler): void {
   ...
   */
  off(event: 'throttled', handler: EventHandler): void {
   ...
   */
  private async throttle(delay: number): Promise<void> {
