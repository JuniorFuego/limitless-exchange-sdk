import { SDKConfig, EndpointConfig, AdvancedSDKConfig } from './types.js';
...
let currentConfig: AdvancedSDKConfig | null = null;

export function validateConfig(config: SDKConfig | AdvancedSDKConfig): void {
  if (!config.baseURL) {
  ...
  const advancedConfig = config as AdvancedSDKConfig;
...
export function setConfig(config: SDKConfig | AdvancedSDKConfig): void {
 ...
 */
export function validateConfigOnly(config: SDKConfig | AdvancedSDKConfig): boolean {
  validateConfig(config);
  return true;
}
